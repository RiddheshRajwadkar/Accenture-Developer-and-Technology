...
##### SDLC is never implemented completely sequentially, it is implemented in an iterative and repetitive manner. Notable SDLC implementations are "Waterfall methodologies" and "Agile methodologies". Any methodologies chosen using SDLC ensure us that:
